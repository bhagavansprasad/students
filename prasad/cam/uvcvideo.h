 ...
 * uvcvideo API. This API is deprecated, applications should be recompiled
 * against the public linux/uvcvideo.h header.
 */
...
//#include "/home/bhagavan/sources/uvcvideo/include/linux/usb/video.h"
#include "linux/uvcvideo.h"
//#include "/home/bhagavan/sources/uvcvideo/include/linux/uvcvideo.h"
/* --------------------------------------------------------------------------
 * UVC constants
 */
...
#define uvc_trace(flag, msg...) \
	do { \
		if (uvc_trace_param & flag) \
			printk(KERN_DEBUG "Aura in uvc_trace uvcvideo: " msg); \
	} while (0)
...
#define uvc_printk(level, msg...) \
	printk(level "aura--uvcvideo: " msg)
